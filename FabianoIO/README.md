🏦 **FabianoIO - Plataforma de Educação Online**

Bem-vindo ao FabianoIO, um projeto desenvolvido no **MBA DevXpert Full Stack .NET** para o módulo 3. O FabianoIO é uma solução inovadora para Educação Online, permitindo que os usuários acompanhem seus cursos, e certificados de maneira intuitiva através de uma API RESTful robusta.
...
src/
 ...
 ├── FabianoIO.API/      # API RESTful
 
 ├── FabianoIO.Core/     # Regras de negócio e validações
...
git clone https://github.com/ProfinProject/ProFin.git](https://github.com/FabianoMaciel/FabianoIO.git)
cd ProFin
...
cd FabianoIO/src/FabianoIO.API
